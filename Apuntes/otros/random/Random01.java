...
class RandomMetod{
    void generarIntAleatorio(){
        ...
        System.out.println("El número otros.random elegido entre 0 y 9 es...: " + randomNum);
    }
    ...
    void generarIntAleatorio2(){
        ...
        System.out.println("El número otros.random elegido entre 1 y 10 es...: " + randomNum);
    }
    ...
    void generarFloatAleatorio(){
        ...
        System.out.println("El número otros.random flotante entre 0 y 9 es...: " + randomFloat);
    }
}
