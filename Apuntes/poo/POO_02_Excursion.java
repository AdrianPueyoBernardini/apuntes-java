...
//Creación básica del objeto con Getters, setters y constructor
public class POO_02_Excursion {
    ...
    public POO_02_Excursion(String nombre, double duracion, double distancia, int dificultad){
        this.nombre = nombre;
